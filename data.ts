...
export const CLASSES: Record<string, ClassData> = {
  Lord: {
    ...
    caps: { hp: 60, str: 27, skl: 29, spd: 30, lck: 30, def: 24, res: 22, con: 20 },
  ...
  Thief: {
    ...
    caps: { hp: 60, str: 22, skl: 30, spd: 30, lck: 30, def: 20, res: 20, con: 20 },
  ...
  Pegasus: {
    ...
    caps: { hp: 60, str: 23, skl: 25, spd: 28, lck: 30, def: 22, res: 28, con: 20 },
  ...
  Shaman: {
    ...
    caps: { hp: 60, str: 29, skl: 26, spd: 26, lck: 30, def: 24, res: 28, con: 20 },
...
export const WEAPONS: WeaponData[] = [
  ...
  { name: 'Steel Sword', type: 'sword', rank: 'D', mt: 11, hit: 75, wt: 8, crit: 0, magic: false },
  { name: 'Iron Blade', type: 'sword', rank: 'D', mt: 13, hit: 70, wt: 12, crit: 0, magic: false },
  { name: 'Armourslayer', type: 'sword', rank: 'C', mt: 8, hit: 80, wt: 11, crit: 0, magic: false, effective: ['armored'] },
  { name: 'Longsword', type: 'sword', rank: 'C', mt: 6, hit: 85, wt: 10, crit: 0, magic: false, effective: ['mounted'] },
  ...
  { name: 'Steel Lance', type: 'lance', rank: 'D', mt: 12, hit: 70, wt: 12, crit: 0, magic: false },
  ...
  { name: 'Steel Axe', type: 'axe', rank: 'D', mt: 13, hit: 65, wt: 14, crit: 0, magic: false },
  { name: 'Hand Axe', type: 'axe', rank: 'D', mt: 7, hit: 60, wt: 10, crit: 0, magic: false, defBonus: 4 },
  { name: 'Hammer', type: 'axe', rank: 'C', mt: 12, hit: 55, wt: 15, crit: 0, magic: false, effective: ['armored'] },
  { name: 'Halberd', type: 'axe', rank: 'C', mt: 10, hit: 60, wt: 14, crit: 0, magic: false, effective: ['mounted'] },
  ...
  { name: 'Steel Bow', type: 'bow', rank: 'D', mt: 11, hit: 70, wt: 8, crit: 0, magic: false, effective: ['flying'] },
  ...
  // { name: 'Arrowspate', type: 'ballista', rank: 'D', mt: 12, hit: 80, wt: 20, crit: 0, magic: false, effective: ['flying'] },
...
U('Oswin','Knight','lance',     {bTotal:37,hp:24,str:11,skl:8,spd:4,lck:3,def:9,res:2,con:14},  {hp:90,str:40,skl:30,spd:30,lck:35,def:55,res:5,gTotal:285},'blue'),
...
U('Heath','Wyvern','lance',     {bTotal:38,hp:24,str:8,skl:7,spd:7,lck:7,def:8,res:1,con:9},   {hp:80,str:50,skl:50,spd:40,lck:20,def:30,res:10,gTotal:280},'red'),
U('Vaida','Wyvern','lance',     {bTotal:42,hp:27,str:11,skl:8,spd:8,lck:4,def:9,res:2,con:12}, {hp:80,str:45,skl:35,spd:30,lck:25,def:25,res:15,gTotal:255},'purple',2),
U('Cormag','Wyvern','lance',    {bTotal:36,hp:22,str:10,skl:5,spd:6,lck:3,def:10,res:2,con:11}, {hp:85,str:55,skl:40,spd:40,lck:35,def:25,res:5,gTotal:285},'blue',2),
U('Melady','Wyvern','lance',    {bTotal:42,hp:25,str:8,skl:11,spd:7,lck:3,def:10,res:3,con:9},  {hp:75,str:50,skl:50,spd:35,lck:25,def:20,res:10,gTotal:265},'red',2),

U('Dorcas','Fighter','axe',     {bTotal:26,hp:30,str:7,skl:7,spd:6,lck:3,def:3,res:0,con:14},   {hp:80,str:60,skl:40,spd:30,lck:45,def:25,res:15,gTotal:295},'gold'),
U('Bartre','Fighter','axe',     {bTotal:27,hp:32,str:9,skl:5,spd:3,lck:6,def:4,res:0,con:13},   {hp:85,str:50,skl:35,spd:40,lck:20,def:30,res:25,gTotal:285},'red', 2),
U('Geitz','Fighter','axe',      {bTotal:34,hp:27,str:7,skl:8,spd:7,lck:5,def:6,res:1,con:13},  {hp:85,str:50,skl:30,spd:40,lck:40,def:20,res:20,gTotal:285},'green'),
U('Garcia','Fighter','axe',     {bTotal:30,hp:28,str:8,skl:7,spd:6,lck:3,def:5,res:1,con:13},   {hp:80,str:65,skl:40,spd:30,lck:40,def:25,res:15,gTotal:295},'gold'),
U('Ross','Fighter','axe',       {bTotal:24,hp:22,str:5,skl:2,spd:5,lck:8,def:3,res:1,con:8},    {hp:95,str:75,skl:50,spd:40,lck:50,def:30,res:30,gTotal:370},'blue'),
U('Dart','Fighter','axe',       {bTotal:30,hp:27,str:8,skl:5,spd:7,lck:3,def:6,res:1,con:10},   {hp:70,str:65,skl:20,spd:60,lck:35,def:20,res:15,gTotal:285},'red'),
...
U('Rebecca','Archer','bow',     {bTotal:23,hp:17,str:4,skl:5,spd:6,lck:4,def:3,res:1,con:5},    {hp:60,str:40,skl:60,spd:60,lck:50,def:15,res:35,gTotal:320},'green'),
...
U('Louise','Archer','bow',      {bTotal:40,hp:19,str:7,skl:9,spd:9,lck:7,def:3,res:5,con:6},    {hp:60,str:35,skl:45,spd:40,lck:30,def:15,res:30,gTotal:255},'purple', 2),
...
U('Innes','Archer','bow',       {bTotal:39,hp:21,str:7,skl:8,spd:9,lck:6,def:6,res:3,con:9},  {hp:75,str:40,skl:40,spd:45,lck:45,def:20,res:25,gTotal:290},'gold'),
...
U('Erk','Mage','anima',         {bTotal:27,hp:17,str:5,skl:6,spd:7,lck:3,def:2,res:4,con:5},    {hp:70,str:60,skl:40,spd:50,lck:30,def:20,res:40,gTotal:310},'purple'),
U('Nino','Mage','anima',        {bTotal:30,hp:15,str:3,skl:4,spd:8,lck:8,def:2,res:5,con:3},    {hp:60,str:50,skl:55,spd:60,lck:45,def:15,res:50,gTotal:335},'green'),
U('Pent','Mage','anima',        {bTotal:45,hp:22,str:8,skl:9,spd:10,lck:7,def:4,res:7,con:7},   {hp:55,str:30,skl:20,spd:40,lck:40,def:30,res:35,gTotal:250},'blue', 2),
U('Lute','Mage','anima',        {bTotal:35,hp:17,str:6,skl:6,spd:7,lck:8,def:3,res:5,con:3},    {hp:50,str:65,skl:30,spd:45,lck:45,def:15,res:40,gTotal:290},'purple'),
U('Saleh','Mage','anima',       {bTotal:40,hp:23,str:8,skl:8,spd:8,lck:5,def:5,res:6,con:8},    {hp:55,str:30,skl:40,spd:40,lck:30,def:25,res:45,gTotal:265},'gold'),
...
U('Lucius','Monk','light',      {bTotal:32,hp:18,str:7,skl:6,spd:10,lck:2,def:1,res:6,con:6},   {hp:60,str:60,skl:50,spd:40,lck:20,def:10,res:60,gTotal:305},'blue'),
U('Renault','Monk','light',     {bTotal:38,hp:22,str:6,skl:9,spd:7,lck:4,def:5,res:7,con:9},    {hp:65,str:40,skl:35,spd:35,lck:15,def:20,res:45,gTotal:255},'red', 2),
U('Artur','Monk','light',       {bTotal:30,hp:19,str:6,skl:6,spd:8,lck:2,def:2,res:6,con:6},    {hp:60,str:50,skl:50,spd:40,lck:25,def:15,res:55,gTotal:295},'gold'),
U('Riev','Monk','light',        {bTotal:33,hp:22,str:6,skl:7,spd:6,lck:3,def:5,res:6,con:8},    {hp:80,str:45,skl:35,spd:30,lck:20,def:25,res:60,gTotal:295},'purple'),
U('Saul','Monk','light',        {bTotal:28,hp:20,str:5,skl:6,spd:7,lck:2,def:2,res:6,con:6},    {hp:70,str:40,skl:45,spd:45,lck:15,def:15,res:50,gTotal:280},'green'),

U('Canas','Shaman','dark',      {bTotal:37,hp:20,str:8,skl:7,spd:7,lck:6,def:4,res:5,con:7},    {hp:75,str:45,skl:40,spd:35,lck:25,def:25,res:45,gTotal:290},'purple'),
U('Raigh','Shaman','dark',      {bTotal:41,hp:23,str:9,skl:5,spd:7,lck:6,def:5,res:9,con:4},    {hp:60,str:45,skl:55,spd:40,lck:15,def:15,res:20,gTotal:250},'purple'),
U('Knoll','Shaman','dark',      {bTotal:29,hp:18,str:8,skl:6,spd:6,lck:0,def:2,res:7,con:7},    {hp:75,str:50,skl:40,spd:35,lck:20,def:10,res:45,gTotal:275},'blue'),
U('Sophia','Shaman','dark',     {bTotal:24,hp:15,str:6,skl:2,spd:4,lck:3,def:1,res:8,con:3},    {hp:65,str:70,skl:40,spd:40,lck:20,def:20,res:75,gTotal:330},'blue'),
U('Lyon','Shaman','dark',       {bTotal:35,hp:20,str:8,skl:7,spd:5,lck:3,def:4,res:8,con:8},    {hp:75,str:55,skl:45,spd:25,lck:25,def:25,res:55,gTotal:305},'purple'),
...
U('Moulder','Cleric','staff',   {bTotal:27,hp:20,str:4,skl:6,spd:6,lck:2,def:4,res:5,con:9},    {hp:70,str:40,skl:50,spd:40,lck:20,def:30,res:25,gTotal:275},'blue'),
...
export function gameOrigins(): string[] {
  return [...new Set(ALL_BASES.map((u) => u.origin || ''))].sort()
}
