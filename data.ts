...
export const TEACHABLE_SKILLS: SkillData[] = [
  ...
  { rarity: 'normal', id: 'camaraderie', name: 'Camaraderie', desc: 'Restores 5 HP each turn if at least two allies are alive.', source: 'Fates Sky Knight', classes: SKILL_CLASS_GROUPS.pegasus, family: 'survival', trigger: 'turnStart', effect: 'regenFlatIfAlliesAlive', amount: 5 },
