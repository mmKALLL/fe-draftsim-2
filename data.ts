...
U('Heath','Wyvern','lance',     {bTotal:38,hp:24,str:8,skl:7,spd:7,lck:7,def:8,res:1,con:9},   {hp:80,str:50,skl:50,spd:40,lck:20,def:30,res:20,gTotal:290},'red'),
...
U('Cormag','Wyvern','lance',    {bTotal:36,hp:22,str:10,skl:5,spd:6,lck:3,def:10,res:2,con:11}, {hp:85,str:55,skl:40,spd:40,lck:35,def:25,res:15,gTotal:295},'blue',2),
U('Melady','Wyvern','lance',    {bTotal:42,hp:25,str:8,skl:11,spd:7,lck:3,def:10,res:3,con:9},  {hp:75,str:50,skl:50,spd:35,lck:25,def:20,res:5,gTotal:260},'red',2),
...
U('Erk','Mage','anima',         {bTotal:27,hp:17,str:5,skl:6,spd:7,lck:3,def:2,res:4,con:5},    {hp:65,str:60,skl:40,spd:50,lck:30,def:20,res:40,gTotal:305},'purple'),
...
U('Pent','Mage','anima',        {bTotal:45,hp:22,str:8,skl:9,spd:10,lck:7,def:4,res:7,con:7},   {hp:50,str:30,skl:20,spd:40,lck:40,def:30,res:35,gTotal:245},'blue', 2),
...
U('Saleh','Mage','anima',       {bTotal:40,hp:23,str:8,skl:8,spd:8,lck:5,def:5,res:6,con:8},    {hp:50,str:30,skl:40,spd:40,lck:30,def:25,res:45,gTotal:260},'gold'),
...
U('Renault','Monk','light',     {bTotal:38,hp:22,str:6,skl:9,spd:7,lck:4,def:5,res:7,con:9},    {hp:60,str:40,skl:35,spd:35,lck:15,def:20,res:45,gTotal:250},'red', 2),
...
U('Riev','Monk','light',        {bTotal:33,hp:22,str:6,skl:7,spd:6,lck:3,def:5,res:6,con:8},    {hp:75,str:45,skl:35,spd:30,lck:20,def:25,res:60,gTotal:290},'purple'),
...
U('Canas','Shaman','dark',      {bTotal:37,hp:20,str:8,skl:7,spd:7,lck:6,def:4,res:5,con:7},    {hp:70,str:45,skl:40,spd:35,lck:25,def:25,res:45,gTotal:285},'purple'),
...
U('Sophia','Shaman','dark',     {bTotal:24,hp:15,str:6,skl:2,spd:4,lck:3,def:1,res:8,con:3},    {hp:60,str:70,skl:40,spd:40,lck:20,def:20,res:75,gTotal:325},'blue'),
